...
<div class="container">
    ...
    <div class="row align-items-center">
        <button type="button" class="btn btn-primary btn-lg btn-block listafinal">
            <div class="row">
                <div class="col-5">
                    <img src="assets/image/restaurantes/McDonald's_Golden_Arches.svg-min.png" class="rounded float-right">
                </div>
    ...
    <p class="h1 text-center otavio" style = "padding-top: 2%;">Você gostaria de comer nestes
        Restaurantes durante essa semana?</p>
    <div class="row align-items-center">
        <div class="col">
