...
<div class="container">
	...
	<div class="rounded principalvotacao">
		<div class="row">
			...
			<div class="col-6">
				<h1 class="nomerestaurante">McDonald's</h1>
				<h1 class="subtitulo">Fast Food</h1>
			</div>
			<div class="col-3 align-self-end score jonas">
                <img class="imagemscore jonas" src="assets/image/score.png" >
            </div>
		</div>
		<div class="descricao votodiario"></p>
			...
			<p class="descricao">E-Mail: <a href="#">faleconosco@mcdonalds.com.br</a></p>
		...
		<div>
			<p class="descricao confirmacao resultado"><img src="assets/image/Icon ionic-ios-checkmark-circle.png" class="imagemcheckescolha">Restaurante Escolhido!
			</p>
		</div>
		<div class="principalvotacao" align="center>
			<div class="row">
				<div class="col" >
					<button type="button" class="btn btn-primary btn-lg home"><i class="fa fa-home" aria-hidden="true"></i></button>
				</div>
			</div>
			<footer >
				<div class="descricao">
