...
<div class="container">
	...
	<div class="rounded principalvotacao">
		<div class="row">
			...
			<div class="col-6">
				<h1 class="nomerestaurante jonas">{{$restaurante->nmNome}}</h1>
				<h1 class="subtitulo">{{$restaurante->nmTipo}}</h1>
			</div>
		...
		<div class="descricao votodiario"></p>
			...
			<p class="descricao">E-Mail: <a class="faleconoscodiario" href="#">{{$restaurante->email}}</a></p>
			<p class="descricao">Telefone: {{$restaurante->noTelefone}}
				<button type="button" class="btn btn-primary btn-lg telefone"><i class="fa fa-phone" aria-hidden="true">         Ligar</i></button></p></button>
				<p class="descricao">Endereço:{{$restaurante->endereco}}</p>
			</div>
